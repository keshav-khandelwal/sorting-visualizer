...
function App() {
  ...
  return (
    ...
    <div className="App">
  {/* Outer Compact Header with White Border */}
  <div
    style={{
      ...
      padding: '10px 15px',
      width: '90%',
      margin: '10px auto 20px', // tighter vertical spacing
  ...
  >
    {/* Inner Box with Subtle Blue Border */}
    <div
      style={{
        border: '1.5px solid #173f6d',
        borderRadius: '8px',
        padding: '8px 12px',
    ...
    >
      ...
      >
        — By Keshav Khandelwal
      </h3>
    </div>
  </div>
        <div
  style={{
    border: '3px solid #1e3c72', // Dark blue outline
    borderRadius: '16px',
    margin: '10px',
    padding: '10px',
    minHeight: '5vh',
    backgroundColor: '#f9f9f9', // Light background inside
